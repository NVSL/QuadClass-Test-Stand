...
module side(width, height, extension, extension_height, horizontal_brace_width=brace_width, horizontal_mortice_width=mortice_width, vertical_brace_width=brace_width, vertical_mortice_width=mortice_width) {
    ...
    difference() {
        ...
        secured_mortice(48,22, -60, mortice_width=vertical_mortice_width, mortice_hole_distance=v_hole_distance);
        secured_mortice(-48,22, 60, mortice_width=vertical_mortice_width, mortice_hole_distance=v_hole_distance);
        secured_mortice(0,35, 0, mortice_width=horizontal_mortice_width, mortice_hole_distance=h_hole_distance);
